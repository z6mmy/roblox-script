-- WHITELISTED SCRIPT SYSTEM
-- Generated by SCRIPT WHITELIST
-- Users: constipation1233, sanit6yy, FortniteKiller_20
-- Expires: Never

local WHITELIST = {
    ["constipation1233"] = nil,
    ["sanit6yy"] = nil,
    ["FortniteKiller_20"] = nil
}

local KICK_MESSAGE = "You are not whitelisted for this script."
local EXPIRED_MESSAGE = "you can not use this script your time is over"
...
local function checkWhitelist()
    ...
    local expiration = WHITELIST[username]
    if expiration ~= nil then
        local currentTime = os.time()
        if currentTime > expiration then
            player:Kick(EXPIRED_MESSAGE)
            return false
        end
    end
...
-- Check whitelist before running script
